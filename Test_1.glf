# Fidelity Pointwise 2024.2.3 Journal file - Thu Jul 16 13:38:59 2026
...
set _TMP(mode_1) [pw::Application begin DatabaseImport]
  $_TMP(mode_1) initialize -strict -type Automatic {C:/Users/joojo/Desktop/Summer Research/CAD FIles/P088_T121_R103_B1_TEST.STEP.x_t}
  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end
unset _TMP(mode_1)
...
set _DB(1) [pw::DatabaseEntity getByName SolidBody]
